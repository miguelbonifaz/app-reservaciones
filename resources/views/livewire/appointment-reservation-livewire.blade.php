<div>
    ...
    <div class="mx-auto max-w-5xl sm:rounded-md">
        <div class="hidden grid-cols-5 gap-2 mb-6 md:grid">
            <div>
                <label class="text-sm font-bold text-gray-800" for="">1.Servicio</label>
                <div class="h-3 rounded-l-md bg-gray-800 {{ $this->firstStepProgressBarClass }}">
                </div>
            </div>
            <div>
                <label class="text-sm font-bold text-gray-800" for="">2.Hora</label>
                <div class="h-3 bg-gray-800 {{ $this->secondStepProgressBarClass }}">
                </div>
            </div>
            <div>
                <label class="text-sm font-bold text-gray-800" for="">3.Información</label>
                <div class="h-3 bg-gray-800 {{ $this->thirdStepProgressBarClass }}">
                </div>
            </div>
            <div>
                <label class="text-sm font-bold text-gray-800" for="">4.Detalles</label>
                <div class="h-3 bg-gray-800 {{ $this->fourthStepProgressBarClass }}">
                </div>
            </div>
            <div>
                <label class="text-sm font-bold text-gray-800" for="">5.Reservación</label>
                <div class="h-3 rounded-r-md bg-gray-800 {{ $this->fifthStepProgressBarClass }}">
                </div>
            </div>
        </div>
        <div class="bg-white">
                ...
                @if ($currentStep == AppointmentReservationLivewire::STEP_DATE_AND_HOUR)
                    <div class="sm:col-span-2">
                        <div class="flex flex-col space-x-2 lg:flex-row">
                            ...
                            <div>
                                <div
                                    class="px-3 py-2 mb-1 w-32 text-center text-white rounded-lg border border-gray-200 bg-gray-800">
                                    ...
                                    @foreach ($this->availableHours as $data)
                                        <label
                                            ...
                                            <input
                                                ...
                                                @endif
                                                class="mr-1 w-4 h-4 border-gray-300 focus:ring-mariajose_gray text-gray-800"
                                                name="start_time"
                                                type="radio"
                                                value="{{ $data['hour'] }}">
                                            {{ $data['hour'] }}
                                ...
                                <div class="overflow-x-auto -my-2 sm:-mx-6 lg:-mx-8">
                                    <div class="inline-block py-2 min-w-full align-middle sm:px-6 lg:px-8">
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tr>
                                                <th scope="col"
                                                    class="pt-3 pr-6 pb-2 text-lg font-medium font-bold tracking-wider text-left text-gray-800">
                                                    Servicio
                                                </th>
                                                <th scope="col"
                                                    class="px-6 pt-3 pb-2 text-lg font-medium font-bold tracking-wider text-left text-gray-800">
                                                    Fecha
                                                </th>
                                                <th scope="col"
                                                    class="px-6 pt-3 pb-2 text-lg font-medium font-bold tracking-wider text-left text-gray-800">
