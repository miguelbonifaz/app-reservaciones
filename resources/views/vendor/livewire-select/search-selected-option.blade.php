<button
    id="{{ $name }}-selected"
    type="button"
    class="flex items-center py-2 px-3 w-full bg-white rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
...
>
    <span class="{{ $styles['searchSelectedOptionTitle'] }}">
        {{ data_get($selectedOption, 'description', 'Override selectedOption method for a meaningful description') }}
    </span>
