<div class="pb-6 mt-4 border-t border-gray-200 sm:col-span-2">
    <div class="flex justify-between mt-8">
        @if ($stepBack ?? false)
            <button
                ...
                <svg
                    class="relative w-6 h-6" style="top: 1px" fill="currentColor" viewBox="0 0 20 20"
        ...
        @if ($nextStep ?? false)
            <button
                ...
                Siguiente
                <svg class="relative w-6 h-6" style="top: 1px" fill="currentColor" viewBox="0 0 20 20"
                     xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
